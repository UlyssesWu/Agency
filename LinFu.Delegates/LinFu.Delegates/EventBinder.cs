...
namespace LinFu.Delegates
{
    ...
    {
        public static MulticastDelegate BindToEvent(string eventName, object source, Func<object[], object> body)
        {
            if (source == null)
        ...
        public static MulticastDelegate BindToEvent(EventInfo targetEvent, object source, Func<object[], object> body)
        {
            if (source == null)
                throw new ArgumentNullException("source");
